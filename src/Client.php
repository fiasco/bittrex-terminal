...
class Client
{
     ...
     * @param int    $depth  how deep of an order book to retrieve. Max is 50.
     *
     * @return array
     */
     ...
     *
     * @param string $market literal for the market (ex: BTC-LTC)
     * @param int    $count  number of entries to return. Max is 50.
     *
     * @return array
     */
    ...
    {
        $data = $this->call('account/getbalances', array(), true);
        $bal = [];
        foreach ($data as $curr) {
            $bal[$curr['Currency']] = $curr;
        }
     ...
     * @param int    $count  (optional) the number of records to return
     *
     * @return array
     */
